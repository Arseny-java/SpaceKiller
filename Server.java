...
public class Server implements Runnable {
    ...
    public void run() {
        try {
            ...
            serverChannel.bind(new InetSocketAddress("localhost", 23337));
            while (true) {
                ...
                try (SocketChannel socketChannel = serverChannel.accept()) {
                    ...
                    while (socketChannel.isConnected()) {
                        ...
                        System.out.println("Преобразовываем сообщение...");

                        socketChannel.write(ByteBuffer.wrap(("Беспробельное сообщение: " + SpaceKiller.spaceKiller(msg)).getBytes(StandardCharsets.UTF_8)));
                    }
                }
            }
        } catch (IOException e) {
